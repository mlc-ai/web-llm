...
- [mcp-client](mcp-client): connect to a live Model Context Protocol server over Streamable HTTP, discover its tools at runtime, and let the model call them via `tools`/`tool_choice`.
