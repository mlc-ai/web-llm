export default {
	"model_list": [
		...
		},
		{
			...
			"model_lib": "Llama-2-13b-chat-hf-q4f32_1",
		},
		{
		...
		},
		{
			...
			"model_lib": "Llama-2-70b-chat-hf-q4f16_1",
			"required_features": ["shader-f16"],
		},
		{
		...
		},
		{
			...
			"model_lib": "WizardCoder-15B-V1.0-q4f16_1",
			"required_features": ["shader-f16"],
		},
		{
			...
			"model_lib": "WizardCoder-15B-V1.0-q4f32_1",
		},
		{
		...
		},
		{
			...
			"model_lib": "Mistral-7B-Instruct-v0.1-q4f16_1",
			"required_features": ["shader-f16"],
		},
		{
		...
		// Models below fit for 128MB buffer limit (e.g. webgpu on Android)
		{
			...
			"model_lib": "Llama-2-7b-chat-hf-q4f16_1-1k",
			"required_features": ["shader-f16"],
		},
		{
			...
			"model_lib": "RedPajama-INCITE-Chat-3B-v1-q4f16_1-1k",
			"required_features": ["shader-f16"],
		},
		{
			...
			"model_lib": "RedPajama-INCITE-Chat-3B-v1-q4f32_1-1k",
		},
	],
	"model_lib_map": {
