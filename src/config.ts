...
export const prebuiltAppConfig: AppConfig = {
  ...
  model_list: [
    ...
    },
    {
      ...
      model_id: "Phi1.5-q4f16_1-MLC-1k",
      model_lib_url:
    ...
    },
    {
      ...
      model_id: "Phi1.5-q4f32_1-MLC-1k",
      model_lib_url:
    ...
    // TinyLlama
    {
      ...
      model_id: "TinyLlama-1.1B-Chat-v0.4-q0f16-MLC",
      model_lib_url:
        modelLibURLPrefix +
        modelVersion +
    ...
    },
    {
      ...
      model_id: "TinyLlama-1.1B-Chat-v0.4-q0f32-MLC",
      model_lib_url:
        modelLibURLPrefix +
        modelVersion +
